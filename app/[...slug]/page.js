  ...
  const options = {
    ...
    error_category: [
        ...
        },
        {
          ...
          label: "Incorrect Termination - Temp Speed Limit Coded as Legal Speed Limit",
        },
        {
        ...
        },
        {
          ...
          label: "Incorrect Termination – Road Derivation Threshold Reached when Sign Not Present",
        },
        {
          value: "road_derivation_threshold_reached_sign_present",
          label: "Incorrect Termination – Road Derivation Threshold Reached while Sign Present",
        },
        {
    ...
    <>
      {
        <section className="w-full h-screen flex justify-center py-10">
          <div className="lg:shadow-lg md:w-[800px] lg:p-20 lg:rounded-xl p-10">
            ...
            <Formik initialValues={retrievedObject} onSubmit={handleSubmit}>
              {({ values, setFieldValue }) => (
                <Form encType="multipart/form-data">
                  <div className="grid gap-6 gap-y-2 md:grid-cols-2">
                    ...
                    />
                    <Inputs name="do_comments_observation" label="DO Comments Observation" />
                    <Inputs name="topology_id" label="Topology Id" />
                    <Inputs name="logical_sign_id" label="Logical Sign ID" />
                    <Inputs name="observed_speedlimit" label="Observed Speedlimit" />
                    <Inputs name="expected_speedlimit" label="Expected Speedlimit" />
                    <Inputs name="dO_comment_expected" label="DO Comment Expected" />
                    <Inputs name="error_description" label="Error Description" />
                  </div>
